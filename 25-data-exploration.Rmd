...
Translating factor levels for `perceived safety`
```{r}
labelled_wide %>% 
  tabyl(perceived_safety)
```

```{r}
labelled_wide$perceived_safety <- labelled_wide %>% 
  as_factor(perceived_safety, )


#  ifelse(perceived_safety == "Algo inseguro(a)", "Somewhat unsafe", )
         
         
#         "Somewhat safe" = "Algo seguro(a)", "Very unsafe" = "Muy inseguro", "Very safe" = "Muy seguro"
```
